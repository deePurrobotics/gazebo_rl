...
if __name__ == "__main__":
  ...
  # load q tables
  qtable_dir = "/home/linzhank/ros_ws/src/gazebo_rl/scripts/turtlebot/crib_nav/qtables/20181108/_dense_reward"
  with open(os.path.join(qtable_dir, "qtable_1000-1000.txt"), "rb") as pkl:
    Q = pickle.load(pkl)
